...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO);//desabilitar el modo oscuro
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.actaFragment, R.id.zonaFragment, R.id.puestoControlFragment)
